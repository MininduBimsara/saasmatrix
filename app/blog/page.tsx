...
export default function BlogIndexPage() {
  ...
  React.useEffect(() => {
    import('@/lib/clientDb').then((db) => {
      setActivePosts(db.getMergedBlogPosts());
      setIsLoading(false);
    });
  }, []);
      ...
      <main id="blog-index-root" className="flex-grow py-12 font-sans">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="mb-6 text-xs text-slate-400 font-mono">
            <Link href="/" className="hover:text-blue-605">HOME</Link> / THE DISPATCH ESSAYS
          </nav>
          ...
          <div className="max-w-3xl mb-12">
            <p className="text-sm leading-relaxed text-slate-600">
              Unlike our side-by-side matrices which serve buyers in active decision-making processes, the Dispatch explore larger procurement philosophies, licensing traps, and future SaaS pricing loops. 
              Read our{' '}
                ...
                activePosts.map((post) => (
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                      ...
                      {/* Column 1: Issue & Category (Left 3 / 12) */}
                      ...
                      {/* Column 2: Title & Excerpt (Center 7 / 12) */}
                      ...
                      {/* Column 3: Read Time & Date (Right 2 / 12) */}
          ...
          <div className="border-t border-slate-150 pt-8">
            <AdContainer layoutType="top-banner" slotId="blog-index-bottom-banner" />
          </div>
